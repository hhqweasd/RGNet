...
class RGibbsNet(BaseModel):
    def __init__(self, opt):
        super(RGibbsNet, self).__init__(opt)
    ...
    def mlpforward(self, iternum, volatile=False):
        ...
        self.ali_model.mlpforward(iternum)

    def mlptest(self, iternum):
        self.mlpforward(iternum, volatile=True)
    ...
    def optimize_parameters(self, inferring_count=0):
        ...
        self.ali_model.optimize_parameters(inferring_count)
